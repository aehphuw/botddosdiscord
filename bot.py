...
import threading
import psutil
token = "MTA3NTQxNjA4NTMzNzIxMDkxMA.GqgSNl.3BawIwC1tJBsQhH1LDL-Wi_2TwxD76XjcGBlvI"
buyers = []
admins = [1075413584353435721]
ownerList = [1075413584353435721]
...
@bot.command()
async def help(ctx):
	if ctx.author.id in buyers:
		embeds = discord.Embed(title="🚀 **PHUCPC DDOSV2** 🚀", color=0xfcb103)
		...
		embed = discord.Embed(title="🚀 **PHUCPC DDOSV2** 🚀", description="✨ **HELP MENU ✨", color=discord.Colour.random())
		embed.set_author(name="PHUC PC DDos Bot V2", icon_url="https://media2.giphy.com/media/F2U5dFf4LG1zYmnJS2/giphy.gif")
...
async def vpsinfo(ctx):
	...
	embed.set_footer(text="© Owner : phucpcdzai#1306 | Info Bot : 🚀 PHUCPC DDOSV2 🚀", icon_url=ctx.author.avatar)
...
async def Botinfo(ctx):
	embed = discord.Embed(color=0x03ff28)
	embed.set_thumbnail(url="https://i.pinimg.com/originals/8f/f2/10/8ff210a59c7a8eadc434ec303f7a86f5.jpg")
	embed.set_author(name="Bot Info - PHUCPC DDOSV2")
	embed.add_field(name="ID :", value="1015483556501409792")
	embed.add_field(name="Name :", value="PHUCPC DDOSV2")
	...
	embed.set_footer(text="© Owner : phucpcdzai# | Info Bot : 🚀 PHUCPC DDOSV2 🚀", icon_url=ctx.author.avatar)
...
async def Methods(ctx):
	if ctx.author.id in buyers:
		embedc = discord.Embed(title="🚀 **PHUCPC DDOSV2** 🚀", color=0xfcb103)
		...
		embet = discord.Embed(title="🚀 **PHUCPC DDOSV2** 🚀", color=discord.Colour.random())
